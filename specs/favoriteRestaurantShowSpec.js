import FavoriteRestaurantSearchView
  from '../src/scripts/views/pages/loved-restaurants/favorite-restaurant-search-view';
import FavoriteRestaurantShowPresenter
  from '../src/scripts/views/pages/loved-restaurants/favorite-restaurant-show-presenter';
...
describe('Showing all favorite restaurants', () => {
  ...
  describe('When no restaurants have been loved', () => {
    ...
    it('should show the information that no restaurants have been loved', (done) => {
