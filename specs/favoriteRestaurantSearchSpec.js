import FavoriteRestaurantSearchPresenter from '../src/scripts/views/pages/loved-restaurants/favorite-restaurant-search-presenter';
import FavoriteRestaurantIdb from '../src/scripts/data/favorite-restaurant-idb';
import FavoriteRestaurantSearchView from '../src/scripts/views/pages/loved-restaurants/favorite-restaurant-search-view';
...
describe('Searching restaurants', () => {
  ...
  describe('When query is not empty', () => {
    ...
    it('should show - for found restaurant without title', () => {
      ...
      expect(document.querySelectorAll('.restaurant-title')
        .item(0).textContent)
        .toEqual('-');
    });
